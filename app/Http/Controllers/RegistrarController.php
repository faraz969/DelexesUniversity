...
class RegistrarController extends Controller
{
    ...
    {
        // Get all applications that can be reviewed by registrar (hod_status = approved)
        ...
        // Get all applications that have been reviewed by registrar
        ...
        // Get all applications for overview (registrar can see all)
